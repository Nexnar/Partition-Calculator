...
public class TesterUtility {
  ...
  /**
   * Retrieves the list of partitions for the given N. The list of what is returned will vary based
   * on the permutations argument.
   * 
   * @param N            the N value for the partitions
   * @param permutations true if the list should contain all permutations of the partitions, false
   *                     otherwise
  ...
  /**
   * Compares the two lists of partitions based with respect to if the order of numbers matters or
   * not.
   * 
   ...
   * @return true if the list of partitions are exactly the same with respect to the value of
   *         orderMatters, false otherwise
   */
  public static boolean comparePartitionLists(ArrayList<Partition> result,
      ArrayList<Partition> expected, boolean orderMatters) {
